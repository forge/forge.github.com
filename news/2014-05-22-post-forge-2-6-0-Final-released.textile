...
**      String refactoring
**      FORGE-1783: Create a Git Constants and altered the string references.
**      FORGE-1780: Created method to create default commandName based on type name camelcase. Create test class: NewUiCommandWizardTest
...
**      Implemented FORGE-1671
**      Implemented [FORGE-1595] - Being able to create an empty JSF backing bean

* <a href="https://github.com/mbriskar">Matej Briskar</a>
**      FORGE-1750, FORGE-1749: Create command to generate getters and setters
**      Fixing test JavaParserResourcesTest after the maven-optional cleanup

* <a href="https://github.com/rbalent">Robert Balent</a>
**      FORGE-1445 : Enchanted ls command on Java class to show fields and methods separately
**      FORGE-1487 : ls command - Changed formatting to match bash

* <a href="https://github.com/ivannov">Ivan St. Ivanov</a>
**      FORGE-1546 Entity fields larger than 800 symbols should generate text area upon scaffolding.
