...
Want to see a "full example":https://github.com/jboss-jdf/jboss-as-quickstart/tree/master/forge-from-scratch, a quick-start using much of the Forge built-in scaffolding and commands? You can find the full tutorial and instructions "here":https://github.com/jboss-jdf/jboss-as-quickstart/tree/master/forge-from-scratch.
